...
const openEditModal = () => {
  if (props.inscripcion) {
    formIscripcio.value = { ...props.inscripcion };
...
const handleCreateInscripcio = async () => {
  try {
    const response = await fetch(
      `${import.meta.env.VITE_URL_BACK}/assistencies/afegirPersonal`,
      {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(formCrear.value),
      },
    );
    if (response.ok) {
      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="handleUpdate">
          <div class="form-group">
            <label>Nom alumnes</label
            ><input v-model="formIscripcio.nomAlumnes" />
          </div>
          <div class="form-group">
            <label>Cognoms alumnes</label
            ><input v-model="formIscripcio.apellidosAlumnes" />
          </div>
          <div class="form-group">
            <label>Nom profes</label><input v-model="formIscripcio.nomProfes" />
          </div>
          <div class="form-group">
            <label>Cognoms profes</label
            ><input v-model="formIscripcio.apellidosProfes" />
          </div>
