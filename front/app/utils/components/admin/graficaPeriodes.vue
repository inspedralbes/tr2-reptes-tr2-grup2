  ...
  try {
    ...
    for (let i = 0; i < periodes.value.length; i++) {
      ...
      if (year) {
        ...
        for (let j = 0; j < tallers.value.length; j++) {
          if (
            tallers.value[j].periode === periodeId &&
            tallers.value[j].institucio
          ) {
  ...
  <div class="periodes-container">
    ...
    <div v-else class="content">
      <div class="years-container">
        <div
          v-for="(yearData, index) in periodesPerAny"
          :key="index"
          class="year-section"
        >
          ...
          <div class="chart-container">
            <div
              v-for="(periode, pIndex) in yearData.periodes"
              :key="pIndex"
              class="periode-group"
            >
